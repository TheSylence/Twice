...
namespace Twice.Tests.ViewModels.Twitter
{
	...
	public class StatusViewModelTests
	{
		...
		public async Task InlineMediasAreExtractedCorrectly()
		{
			...
			var status = DummyGenerator.CreateDummyStatus();
			status.User.UserID = 222;
			status.Entities.MediaEntities.Add( new MediaEntity {MediaUrl = "https://example.com/1", ExpandedUrl = "https://img.example.com/image1.jpg", ID = 1} );
			status.Entities.MediaEntities.Add( new MediaEntity {MediaUrl = "https://example.com/2", ExpandedUrl = "https://img.example.com/image2.jpg", ID = 2} );
			status.Entities.MediaEntities.Add( new MediaEntity {MediaUrl = "https://example.com/3", ExpandedUrl = "https://img.example.com/image3.jpg", ID = 3} );
		...
		public async Task InlineMediaUseExtendedEntities()
		{
			...
			status.Entities.MediaEntities.Add( new MediaEntity {MediaUrl = "https://example.com/1", ExpandedUrl = "https://img.example.com/image1.jpg", ID = 1} );
			status.Entities.MediaEntities.Add( new MediaEntity {MediaUrl = "https://example.com/2", ExpandedUrl = "https://img.example.com/image2.jpg", ID = 2} );
			status.ExtendedEntities.MediaEntities.Add( new MediaEntity {MediaUrl = "https://example.com/3", ExpandedUrl = "https://img.example.com/image3.jpg", ID = 3} );
