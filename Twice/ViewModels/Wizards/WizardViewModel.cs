...
namespace Twice.ViewModels.Wizards
{
	internal abstract class WizardViewModel : DialogViewModel, IWizardViewModel
	{
		...
		[DebuggerBrowsable( DebuggerBrowsableState.Never )] private WizardPageViewModel _CurrentPage;

		[DebuggerBrowsable( DebuggerBrowsableState.Never )] private RelayCommand _FinishCommand;

		[DebuggerBrowsable( DebuggerBrowsableState.Never )] private RelayCommand _GotoPrevPageCommand;
