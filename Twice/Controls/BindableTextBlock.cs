...
namespace Twice.Controls
{
	...
	internal class BindableTextBlock : TextBlock
	{
		...
		public static readonly DependencyProperty ElementsProperty = DependencyProperty.Register( "Elements", typeof( IEnumerable<Inline> ), typeof( BindableTextBlock ), new PropertyMetadata( null, OnElementsChanged ) );
	}
}