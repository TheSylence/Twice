...
namespace Twice.Behaviors
{
	...
	public class EventToCommand : TriggerAction<DependencyObject>
	{
		...
		///     <para>
		///         To access the EventArgs of the fired event, use a RelayCommand&lt;EventArgs&gt; and leave
		///         the CommandParameter and CommandParameterValue empty!
		///     </para>
		/// </summary>
		...
		protected override void Invoke( object parameter )
		{
			...
			if( SetHandled )
			{
				var evt = parameter as RoutedEventArgs;
				if( evt != null )
				{
					evt.Handled = true;
				}
		...
		///     control is disabled. This is a dependency property.
		/// </summary>
		...
		///     trigger. This is a DependencyProperty.
		/// </summary>
		...
		/// <summary>
		///     Gets or sets an object that will be passed to the <see cref="Command" /> attached to this
		///     trigger. This property is here for compatibility with the Silverlight version. This is
		///     NOT a DependencyProperty. For databinding, use the <see cref="CommandParameter" /> property.
		/// </summary>
		...
		///     <see
		///         cref="PassEventArgsToCommand" />
		///     . If PassEventArgsToCommand is false, this property is
		///     never used.
		/// </summary>
		...
		///         cref="PassEventArgsToCommand" />
		///     . If PassEventArgsToCommand is false, this property is
		///     never used. This is a dependency property.
		/// </summary>
		...
		///     <see cref="Command" /> property's CanExecuteChanged event fires. If this property is true,
		///     and the command's CanExecute method returns false, the element will be disabled. If this
		///     property is false, the element will not be disabled when the command's CanExecute method
		///     changes. This is a DependencyProperty.
		/// </summary>
		...
		///     Gets or sets a value indicating whether the attached element must be disabled when the
		///     <see cref="Command" /> property's CanExecuteChanged event fires. If this property is true,
		///     and the command's CanExecute method returns false, the element will be disabled. This
		///     property is here for compatibility with the Silverlight version. This is NOT a
		///     DependencyProperty. For databinding, use the <see cref="MustToggleIsEnabled" /> property.
		/// </summary>
		public bool MustToggleIsEnabledValue
		{
			get { return _MustToggleValue ?? MustToggleIsEnabled; }
		...
		/// <summary>
		///     Specifies whether the EventArgs of the event that triggered this action should be passed
		///     to the bound RelayCommand. If this is true, the command should accept arguments of the
		///     corresponding type (for example RelayCommand&lt;MouseButtonEventArgs&gt;).
		/// </summary>
